...
public class Tree<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        Tree<String, Integer> tree = new Tree<>(bst);
        tree.put("S", 5);
        tree.put("E", 5);
        tree.put("A", 10);
        tree.put("C", 11);
        ...
        BST<Integer, String> bstTwo = new BST<>();
        Tree<Integer, String> treeTwo = new Tree<>(bstTwo);
        treeTwo.put(3, "N");
        treeTwo.put(6, "K");
        treeTwo.put(1, "A");
        treeTwo.put(14, "J");
        ...
        System.out.println(treeTwo.isOrdered(1, 14));
        treeTwo.changeKey(3, 99);
        System.out.println(treeTwo);
        System.out.println(treeTwo.isOrdered(1, 99));

    }

    public void changeKey(Key old, Key newKey) {
        changeKey(root, old, newKey);
    }
    ...
    private void addItems() {
        for (Key key : this.bst.levelOrder()) {
            this.put(key, this.bst.get(key));
        }
    }
    ...
    private StringBuilder toStringBuilder(Node node, String direction, StringBuilder stringBuilder, int size) {
        if (node == null) {
        ...
        stringBuilder.append(size).append(" ").append(node.key).append("->").append(node.val).append("[");
        toStringBuilder(node.left, "LEFT", stringBuilder, size + 1);
        toStringBuilder(node.right, "RIGHT", stringBuilder, size + 1);
        return stringBuilder;
    }
